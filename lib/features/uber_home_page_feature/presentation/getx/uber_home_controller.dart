...
import 'package:shaheendrive/features/uber_home_page_feature/domain/use_cases/get_user_current_location_usecase.dart';

class UberHomeController extends GetxController {
  final GetUserCurrentLocationUsecase getUserCurrentLocationUsecase;

  var currentLat = 73.33.obs;
  var currentLng = 33.32.obs;
  ...
  animateCamera() async {
    await getUserCurrentLocationUsecase.call().then((value) {
     ...
     // Check if completer is not completed
