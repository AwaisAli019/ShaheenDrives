...
class detailservices3 extends StatefulWidget {
  const detailservices3({Key? key}) : super(key: key);

  @override
  State<detailservices3> createState() => _detailservices3State();
}

class _detailservices3State extends State<detailservices3> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            'Electrician       ',style: TextStyle(color: Colors.lightGreen),
          ),
        ),
      ...
      body: Stack(
        children: [
          ...
          Positioned(
              ...
              child:Image.asset('assets/electrician.png',width: 250,height: 250,)
          ),
          Positioned(
              bottom: 250,
