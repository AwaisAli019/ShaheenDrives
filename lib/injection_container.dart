...
import 'package:shaheendrive/features/uber_auth_feature/data/data_sources/uber_auth_data_source.dart';
import 'package:shaheendrive/features/uber_auth_feature/data/data_sources/uber_auth_data_source_impl.dart';
import 'package:shaheendrive/features/uber_auth_feature/data/repositories/uber_auth_repository_impl.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/repositories/uber_auth_repository.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/use_cases/uber_add_profile_image_usecase.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/use_cases/uber_auth_check_user_status_usecase.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/use_cases/uber_auth_get_user_uid_usecase.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/use_cases/uber_auth_is_sign_in_usecase.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/use_cases/uber_auth_otp_verification_usecase.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/use_cases/uber_auth_phone_verification_usecase.dart';
import 'package:shaheendrive/features/uber_auth_feature/domain/use_cases/uber_auth_sign_out_usecase.dart';
import 'package:shaheendrive/features/uber_home_page_feature/presentation/getx/uber_home_controller.dart';
import 'package:shaheendrive/features/uber_map_feature/data/data_sources/uber_map_data_source.dart';
import 'package:shaheendrive/features/uber_map_feature/data/data_sources/uber_map_data_source_impl.dart';
import 'package:shaheendrive/features/uber_map_feature/data/repositories/uber_map_repository_impl.dart';
import 'package:shaheendrive/features/uber_map_feature/domain/repositories/uber_map_repository.dart';
import 'package:shaheendrive/features/uber_map_feature/domain/use_cases/cancel_trip_usecase.dart';
import 'package:shaheendrive/features/uber_map_feature/domain/use_cases/uber_map_direction_usecase.dart';
import 'package:shaheendrive/features/uber_map_feature/domain/use_cases/uber_map_get_drivers_usecase.dart';
import 'package:shaheendrive/features/uber_map_feature/domain/use_cases/uber_map_prediction_usecase.dart';
import 'package:shaheendrive/features/uber_map_feature/domain/use_cases/uber_trip_payment_usecase.dart';
import 'package:shaheendrive/features/uber_map_feature/domain/use_cases/vehicle_details_usecase.dart';
import 'package:shaheendrive/features/uber_map_feature/presentation/getx/uber_map_controller.dart';
import 'package:shaheendrive/features/uber_profile_feature/data/data_sources/uber_profile_data_source.dart';
import 'package:shaheendrive/features/uber_profile_feature/data/data_sources/uber_profile_data_source_impl.dart';
import 'package:shaheendrive/features/uber_profile_feature/data/repositories/uber_profile_repository_impl.dart';
import 'package:shaheendrive/features/uber_profile_feature/domain/repositories/uber_profile_repository.dart';
import 'package:shaheendrive/features/uber_profile_feature/domain/use_cases/uber_profile_get_rider_usecase.dart';
import 'package:shaheendrive/features/uber_profile_feature/domain/use_cases/uber_wallet_add_money_usecase.dart';
import 'package:shaheendrive/features/uber_profile_feature/presentation/getx/uber_profile_controller.dart';
import 'package:shaheendrive/features/uber_trips_history_feature/data/data_sources/uber_trips_history_data_source.dart';
import 'package:shaheendrive/features/uber_trips_history_feature/data/repositories/uber_trips_history_repository_impl.dart';
import 'package:shaheendrive/features/uber_trips_history_feature/domain/repositories/uber_trips_history_repository.dart';
import 'package:shaheendrive/features/uber_trips_history_feature/domain/use_cases/uber_get_trip_driver_usecase.dart';
import 'package:shaheendrive/features/uber_trips_history_feature/domain/use_cases/uber_get_trip_history_usecase.dart';
import 'package:shaheendrive/features/uber_trips_history_feature/domain/use_cases/uber_give_trip_rating_usecase.dart';
import 'package:shaheendrive/features/uber_trips_history_feature/presentation/getx/uber_trip_history_controller.dart';
